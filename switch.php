        ...
        <div class='switch_container'>
            <div class="switch-holder">
                ...
                <div class="switch-toggle">
                    <input type="checkbox" id="bluetooth" class="status-toggle" data-item-id="<?php echo $row[0][0]; ?>"
                        <?php if ($ac_status == 1) { ?>checked <?php } ?>>
            ...
            <div class="switch-holder">
                <div class="switch-label">
                    <i class="fa fa-bluetooth1-b"></i><span>TV</span>
                </div>
                <div class="switch-toggle">
                    <input type="checkbox" id="bluetooth1" class="status-toggle"
                        data-item-id="<?php echo $row[1][0]; ?>" <?php if ($tv_status == 1) { ?>checked <?php } ?>>
