...
$sql = "SELECT * from tbl_temperature1 order by id desc limit 1";
...
if ($result->num_rows > 0) {
    ...
    //     echo "<span id='' style='color:red;font-size:30px;'>cow is dead</span>";
    // } else {
    //     echo "<span id='' style='color:red;font-size:30px;'>cow is live</span>";
    // }
    echo "<div id='gauge'>
    <div id='major-ticks'>
        <span>0℃</span>
